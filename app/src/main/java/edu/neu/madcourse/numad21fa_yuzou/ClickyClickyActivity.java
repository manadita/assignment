...
public class ClickyClickyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textButtonPressed = findViewById(R.id.txt_buttonpressed);
    ...
    class MyButtoListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.button_a:
                    TextView textPressedA = findViewById(R.id.txt_buttonpressed);
                    textPressedA.setGravity(Gravity.CENTER);
                    textPressedA.setText("Pressed: A ");
                    break;
                case R.id.button_b:
                    TextView textPressedB = findViewById(R.id.txt_buttonpressed);
                    textPressedB.setGravity(Gravity.CENTER);
                    textPressedB.setText("Pressed: B ");
                    break;
                case R.id.button_c:
                    TextView textPressedC = findViewById(R.id.txt_buttonpressed);
                    textPressedC.setGravity(Gravity.CENTER);
                    textPressedC.setText("Pressed: C ");
                    break;
                case R.id.button_d:
                    TextView textPressedD = findViewById(R.id.txt_buttonpressed);
                    textPressedD.setGravity(Gravity.CENTER);
                    textPressedD.setText("Pressed: D ");
                    break;
                case R.id.button_e:
                    TextView textPressedE = findViewById(R.id.txt_buttonpressed);
                    textPressedE.setGravity(Gravity.CENTER);
                    textPressedE.setText("Pressed: E ");
                    break;
                case R.id.button_f:
                    TextView textPressedF = findViewById(R.id.txt_buttonpressed);
